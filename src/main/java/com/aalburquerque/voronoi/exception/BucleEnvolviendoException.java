 ...
 *
 */
public class BucleEnvolviendoException extends RuntimeException implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4047355328328101691L;

	public BucleEnvolviendoException() {

		super("Se produjo una excepcion en el bucle envolviendo a los dos poliedros: No se repite"
				+ " ninguna arista.");
	}
