 ...
 *
 */
public class PocosServidoresException extends RuntimeException implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2892392939344408978L;

	public PocosServidoresException() {

		super("Se intento crear un cliente con un numero de servidores no valido");
	}
